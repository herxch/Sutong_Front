...
const Posts = () => {
  const post1 = `Sutong consolidated its two Houston Distribution Centers of 70,000 square feet to a new 135,000 square foot Center in Brookshire, Texas, just outside of Houston. This Distribution Center allows Sutong to increase our capabilities to serve our customers. Brookshire has complete tire and wheel mounting capabilities to serve those customer requiring assemblies.`;
